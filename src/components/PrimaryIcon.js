...
export default class PrimaryIcon extends Component {
  ...
  shouldComponentUpdate(props) {
    ...
    // If no properties have changed, don't update.
    return false;
  }
    ...
    return (
      <div>
        <Avatar
          ...
          style={{ backgroundImage: this.state.background, backgroundColor: this.state.backgroundColor }}
        >
          {/* Display the supplied text only if a background not also supplied */}
